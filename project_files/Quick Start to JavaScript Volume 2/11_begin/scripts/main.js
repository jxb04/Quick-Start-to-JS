...
var beginningScenarios = ["You wake up in a hospital. It is eerily quiet. You tiptoe to the door and peek out.", "Your are standing in an open field west of a white house with a boarded front door. There is a small mailbox here.", "Desparate times call for desparate measures. You see a small convenience store up ahead and decide to loot it for goods."];
...
alert("Being that it is the zombie apocolypse, you decide to search for a weapon first. After surveying your surroundings, you notice and grab a " + weapon + ".");
